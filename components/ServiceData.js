const services = [
  ...
  //
  {
    ...
    summary:
      'Stone refacing has become a popular way to enhance the exterior beauty of your home using stone products.',
    content: [
      {
        ...
        content: [
          {
            text: [
              'Stone refacing has become a popular way to enhance the exterior beauty of your home using real stone products. Natural refacing allows us to change the look of your home through custom stone renovations eliminating the need to move away from your existing neighbourhood while achieving an updated look for your home or business.',
    ...
    photos: [
      'refacing/stone5-before.jpg',
      'refacing/stone5-after.jpg',
      'refacing/stone6-before.jpg',
      'refacing/stone6-after.jpg',
      'refacing/refacing1-before.jpg',
      'refacing/refacing1-after.jpg',
      'refacing/refacing2-before.jpg',
      'refacing/refacing2-after.jpg',
      'refacing/refacing4-before.jpg',
      'refacing/refacing4-after.jpg',
      'refacing/refacing1_b.jpg',
      'refacing/refacing1_a.jpg',
      'refacing/refacing2_b.jpg',
      'refacing/refacing2_a.jpg',
      'refacing/refacing3_b.jpg',
      'refacing/refacing3_a.jpg',
      'refacing/refacing4_b.jpg',
      'refacing/refacing4_a.jpg',
      'refacing/refacing_steeple_b.jpg',
      'refacing/refacing_steeple_a.jpg',
      'refacing/refacing_york_b.jpg',
      'refacing/refacing_york_a.jpg',
      'refacing/refacing_king_b.jpg',
      'refacing/refacing_king_a.jpg',
      'refacing/lhB.jpg',
      'refacing/lhA.jpg',
      'refacing/wB.jpg',
      'refacing/WA.jpg',
  ...
  //
  {
    ...
    title: 'Flagstone',
    summary:
      'Flagstone can be used to complete your front entrance by adding the beauty of natural stone.',
    content: [
      {
    ...
    photos: [
      'flagstone/flagstone2-before.jpg',
      'flagstone/flagstone2-after.jpg',
      'flagstone/flagstone1-before.jpg',
      'flagstone/flagstone1-after.jpg',
      'flagstone/flagstone_noba_b.jpg',
      'flagstone/flagstone_noba_a.jpg',
      'flagstone/flagstone2_b.jpg',
      'flagstone/flagstone2_a.jpg',
      'flagstone/flagstone3_b.jpg',
      'flagstone/flagstone3_a.jpg',
      'flagstone/BA_ChrysB.jpg',
      'flagstone/BA_ChrysA.jpg',
      'flagstone/bel1.jpeg',
      'flagstone/bel2.jpg',
      'flagstone/br1.jpeg',
      'flagstone/br2.JPG',
  ...
  //
  {
        ...
        content: [
          {
            text: [
              ...
              'Next, we install small 1/2" to 3/4" tubing at two foot intervals on top of footing to allow water to drain from the hydro-static pressure, but we also cover the tubing on the inside with a large aggregate to ensure that the weepers do not get plugged up from soil or clay. In addition to installing active weepers, we install a waterproof membrane on the inside. The retaining wall can be built out of stone, brick or block, the choice is yours.',
              'The final component is the limestone coping that is installed on the top of the retaining wall with a 2" overhang and complete with drip edges to guide water away from your retaining wall.',
            ],
          },
        ],
      },
    ...
    photos: [
      'walls/wall1-before.jpg',
      'walls/wall1-after.jpg',
      'walls/walls1_b.jpg',
      'walls/walls1_a.jpg',
      'walls/walls2_b.jpg',
      'walls/walls2_a.jpg',
      'walls/walls3_b.jpg',
      'walls/walls3_a.jpg',
      'walls/BA_BartonvilleB.jpg',
      'walls/BA_BartonvilleA.jpg',
      'walls/weepersB.jpg',
      'walls/weepersA.jpg',
      'walls/walkoutstone.jpg',
      'walls/walkoutparge.jpg',
      'walls/walkoutinprogress1.jpg',
      'walls/walkoutinprogress2.jpg',
      'walls/nsr1.jpg',
      'walls/nsr2.jpg',
      'walls/mrw1.jpg',
      'walls/mrw2.jpg',
      'foundation/Underpinning1.jpg',
      'foundation/Underpinning2.jpg',
      'foundation/Underpinning3.jpg',
      'foundation/Underpinning4.jpg',
    ],
  },
  //
  // ------- Masonry Repairs (formerly "Brick-Stone") -------
  //
  {
    pageName: 'masonry',
    ...
    content: [
      ...
      },
      {
        ...
        content: [
          {
            text: [
              'The condition of your chimney is very important for many reasons. Even an unused chimney must be maintained to avoid water penetration that can cause exterior as well as interior damage. The chimney requires several key components to be present in order for it to resist the harsh elements. Remember, the chimney stands above the structure and is exposed to the elements wile chimney area under roof is protected.',
      ...
      },
      {
        ...
        content: [
          ...
          {
            list: [
              'They are installed with an insufficient slope downwards and water sits on the brick instead of flowing away from the window.',
              'There are so many mortar joints and therefore too many possible entries for water to penetrate.',
              'There are no drip edges to guide water away from the brick sills and the bricks underneath the sills.',
              'The flashing was installed directly below the window sill, which is more harmful than helpful.',
              'Weep vents are plugged at time of initial construction and water is trapped inside. We can restore your existing brick window sills with proper installation of new brick or install new limestone sills.',
            ],
          },
          {
            title: 'Why Choose Limestone?',
            text: [
              ...
              'Three Little Pigs Masonry offers a 10 year warranty on new stone window sills.',
            ],
          },
        ],
      },
    ...
    photos: [
      'brick-stone/brick1-before.jpg',
      'brick-stone/brick1-after.jpg',
      'brick-stone/brick2-before.jpg',
      'brick-stone/brick2-after.jpg',
      'brick-stone/brick3-before.jpg',
      'brick-stone/brick3-after.jpg',
      'brick-stone/chimney1-before.jpg',
      'brick-stone/chimney1-after.jpg',
      'brick-stone/steps3-before.jpg',
      'brick-stone/steps3-after.jpg',
      'brick-stone/masonry1_b.jpg',
      'brick-stone/masonry1_a.jpg',
      'brick-stone/masonry2_b.jpg',
      'brick-stone/masonry2_a.jpg',
      'brick-stone/or1.jpg',
      'brick-stone/or2.jpg',
      'brick-stone/rs1.jpg',
      'brick-stone/rs2.jpg',
  ...
  //
  {
    ...
    title: 'Foundations',
    summary:
      'The foundation must be installed with all the necessary and essential components for it to withstand the earth’s shifting and our cold climate.',
    content: [
      {
        ...
        content: [
          ...
          },
          {
            ...
            text: [
              ...
              'Our next step is parging your above grade foundation. We use the highest quality fibre parge available on the market. It is professionally applied to the prepared foundation and achieves a sandstone water repellant finish.',
            ],
          },
          {
            title: 'Washable Water Repellant Colour Coating',
            text: [
              'Our final recommended step is a washable water repellant fibre colour coating that leaves your foundation with an even clean and crisp appearance that will last for many years. Our parging process can be applied to many other concrete areas of your home that require attention.',
            ],
          },
          {
      ...
      },
      {
        ...
        content: [
          {
            text: [
              'Our experience with most basement waterproofing projects is very simple. Most cracked foundations are the result of one or more of the following:',
            ],
          },
          {
            list: [
              'The concrete being placed or poured should have been reinforced horizontally as well as vertically. Without STEEL REBAR reinforcement being part of the component for concrete, it is virtually useless (particularly when you have hydrostatic pressure coming from your 8-foot deep soil, clay or aggregate).',
          ...
          {
            text: [
              'In our opinion, repairing or injecting a type of epoxy for the interior of the concrete is only a temporary fix and not long-term basement waterproofing. Water will find its way in somewhere else. With basement waterproofing, usually we have to excavate the problem area or areas right down to the footing. We then check the weeping tile to make sure that after we leave the area that it is in good shape. If it too is defective, we must repair it. We will clean and grind the area. After locating the crack or cracks, we grind a wedge type groove in this area to a depth of at least 5/8". We then tuck point a dry mortar (non-shrink type), such as a pre-hydrated mortar or a hydraulic mortar. It is very important that you have a mason repair any cracks before having any waterproofing being done. Both should be monitored and brushed while mortar is setting to ensure no cracks are visible. We then install a water membrane and if required for concrete block, we will parge the wall first, before we install our water membrane.',
              'If it is a stone foundation, we will tuck point all defective mortar joints prior to installing a trowel on rubber water proof membrane to ensure that all voids and protrusions are completely covered, creating a 100% seal for the foundation.  Because rubber allows the protective membrane to move with the foundation. We backfill soil/clay/aggregate and return all landscaping, interlock or steps back to original state.',
      ...
      },
      {
        ...
        content: [
          {
            text: [
              'Most people renovate or restore their homes from the grade levels up but never does a homeowner think they have to replace their foundation',
              'Underpinning is seldom heard of outside of the GTA which adheres to the Provincial building code ( OBC ) which still today does not use steel reinforcement in their foundations.',
              'The rest of the province and the rest of the country work by the Federal building code ( NBC) which is a much superior building code and really is supposed to be the minimum requirements for all the provinces of Canada, except for British Columbia, because of their seismic areas the building code is much higher there than the NBC.',
              'For many years, right up until the mid-70s, foundations in the GTA were mostly built by ‘’hollow’’ concrete blocks ( except for the filled top course ) unlike NBC which requires solid steel reinforcement and solid filled concrete block from the footing to the sill plate, or formed and poured ( placed ) concrete with steel reinforcement. In the mid-70s, the GTA was experiencing problems with their foundations and blamed it on the concrete blocks, so they decided to switch and start using formed and poured concrete.',
              'The problem that they know they have solid concrete but there is still no reinforcement unlike the homes for example, in the Ottawa area, please see in pics, how often the rebar is placed, and special bridging placed to ensure steel rebar rods are located in the center of concrete.',
            ],
          },
        ],
      },
    ...
    photos: [
      'foundation/parging1-before.jpg',
      'foundation/parging1-after.jpg',
      'foundation/parging2-before.jpg',
      'foundation/parging2-after.jpg',
      'foundation/parging4-before.jpg',
      'foundation/parging4-after.jpg',
      'foundation/parging5-before.jpg',
      'foundation/parging5-after.jpg',
      'foundation/p1.jpg',
      'foundation/p2.jpg',
      'foundation/pp1.jpg',
      'foundation/pp2.jpg',
  ...
  //
  {
    ...
    summary:
      'Concrete cracks are a common problem throughout the GTA. The majority of these cracks are caused by the failure to ensure proper reinforcement at time of installation.',
    content: [
      {
      ...
      },
      {
        ...
        content: [
          ...
          {
            title: 'Here are some of the issues homeowners ask us to correct:',
            list: [
              ...
              'Damaged concrete steps covered in flagstone that is cracked and lifting plus the sides of steps (brick or stone) are also deteriorating.',
        ...
        content: [
          {
            text: [
              ...
              'Three Little Pigs Masonry also offers concrete walkways and sidewalks installed by the Ontario Building Code.',
            ],
          },
        ],
      },
    ...
    photos: [
      'concrete/concrete1-before.jpg',
      'concrete/concrete1-after.jpg',
      'concrete/concrete2-before.jpg',
      'concrete/concrete2-after.jpg',
      'concrete/steps1-before.jpg',
      'concrete/steps1-after.jpg',
      'concrete/steps2-before.jpg',
      'concrete/steps2-after.jpg',
      'concrete/sidewalk1-before.jpg',
      'concrete/sidewalk1-after.jpg',
      'walls/wall1-before.jpg',
      'walls/wall1-after.jpg',
      'concrete/concrete2_b.jpg',
      'concrete/concrete2_a.jpg',
      'concrete/concrete3_b.jpg',
      'concrete/concrete3_a.jpg',
      'concrete/c1_before.jpg',
      'concrete/c1_after.jpg',
      'concrete/cs1.jpg',
      'concrete/cs2.jpg',
      'concrete/fs1.jpg',
      'concrete/fs2.jpg',
